...
async function startEza() {
  ...
  const client = EzaConnect({
    ...
    browser: [global.author, "Opera", "1.0.0"],
  ...
  client.ev.on("messages.upsert", async (chatUpdate) => {
    ...
    try {
      ...
      require("./setting/mechaine")(client, m, chatUpdate, store, set_open, set_close, antilink, antiwame, antilink2, antiwame2, simisimi, _left, _welcome, set_welcome_db, set_left_db);
    } catch (err) {
      console.log(err);
    }
  });
